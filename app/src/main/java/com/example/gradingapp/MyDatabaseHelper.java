...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "my_grades";
    private static final String COLUMN_ID = "_id";
    private static final String COLUMN_NAME = "name";
    private static final String COLUMN_PROG_CODE = "program_code";
    ...
    public void addStudentInfo(String name, String prog_code, String grade, String duration, int fees){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_NAME, name);
        cv.put(COLUMN_PROG_CODE, prog_code);
        cv.put(COLUMN_GRADE, grade);
        cv.put(COLUMN_DURATION, duration);
        cv.put(COLUMN_FEES, fees);
