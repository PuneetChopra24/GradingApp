...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public CustomAdapter(Context context, ArrayList studentId, ArrayList studentName, ArrayList studentProg_Code, ArrayList courseDuration, ArrayList studentGrade, ArrayList studentFees){
